<script lang="ts">
    ...
    const terrainColors = [
        ...
        { label: "Shelf", color: "rgb(25, 118, 210)", desc: "-200m" }, // 0.1, 0.46, 0.82
        { label: "Slope", color: "rgb(13, 59, 92)", desc: "-2000m" }, // 0.05, 0.23, 0.36
        { label: "Abyssal", color: "rgb(10, 26, 41)", desc: "-4000m" }, // 0.04, 0.1, 0.16
        { label: "Deep Ocean", color: "rgb(5, 13, 26)", desc: "< -6000m" }, // 0.02, 0.05, 0.1
    ];
    ...
    const biomeColors = [
        ...
        { label: "Ocean", color: "rgb(26, 77, 153)" }, // 0.1, 0.3, 0.6
    ];
...
>
    ...
    {#if expanded}
        ...
        >
            <!-- Mode Toggle - Only useful if we support switching, currently renderer decides based on isSimulated -->
            <!-- But user might want to see both sets of colors reference -->
            ...
            <div>
                <h4
                    class="font-bold text-gray-400 mb-2 mt-4 uppercase text-[10px] tracking-wider"
                >
                    Biomes
                </h4>
                <div class="space-y-1">
