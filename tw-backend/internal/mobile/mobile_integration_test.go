...
func (s *MobileSDKIntegrationSuite) SetupSuite() {
	...
	gameProcessor := processor.NewGameProcessor(authRepo, worldRepo, nil, lookService, entitySvc, interviewService, spatialSvc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
