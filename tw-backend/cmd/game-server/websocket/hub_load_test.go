...
func TestHub_LoadTest_1000Clients(t *testing.T) {
	...
	lookService := look.NewLookService(worldRepo, nil, nil, interviewRepo, authRepo, nil, nil)
	spatialSvc := player.NewSpatialService(authRepo, worldRepo, nil)
	gameProc := processor.NewGameProcessor(authRepo, worldRepo, nil, lookService, nil, nil, spatialSvc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
