...
### Prompt:
```
Following TDD principles, implement Phase 0.2 Authentication & Security:
...
1. Attribute schema
   ...
   - Secondary (4): MaxHP (Health*10), MaxStamina (Health*5 + Agility*5), MaxFocus (Wits*10), MaxMana (Wisdom*10)
